            ...
            type: function (type) {
                ...
                switch (type) {
                    ...
                    case 'alphanum':
                        ...
                        break;
                    case 'url':
                        assert = new Validator.Assert().Regexp('(https?:\\/\\/)?(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{2,256}\\.[a-z]{2,20}\\b([-a-zA-Z0-9@:%_\\+.~#?&//=]*)', 'i');
                        break;
                    default:
    ...
    ParsleyUI.prototype = {
        ...
        reflow: function (fieldInstance) {
            ...
            if ((diff.kept.length || diff.added.length) && 'undefined' === typeof fieldInstance._ui.failedOnce) {
                //this.manageFailingFieldTrigger(fieldInstance);  //TODO i want to avoid this behavior
            }
        },
